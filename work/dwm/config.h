...
static const char col_gray1[]       = "#282F37"; /* bar bg */
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb"; /* bar fg */
static const char col_gray4[]       = "#2AA198"; /* selection fg */
static const char col_cyan[]        = "#282F37"; /* selection bg */
...
static const char *roficmd[] = { "rofi", "-no-lazy-grab", "-show", "drun", NULL };
