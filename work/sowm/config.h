...
static struct key keys[] = {
    ...
    {MOD,           	XK_k,      	move,  {.com=(char*[]){"move", "up"}, .i=20}},
    {MOD,           	XK_l,      	move,  {.com=(char*[]){"move", "right"}, .i=20}},
    {MOD|ShiftMask, 	XK_h,      	move,  {.com=(char*[]){"resize", "left"}, .i=20}},
    {MOD|ShiftMask, 	XK_j,      	move,  {.com=(char*[]){"resize", "down"}, .i=20}},
    {MOD|ShiftMask, 	XK_k,      	move,  {.com=(char*[]){"resize", "up"}, .i=20}},
    {MOD|ShiftMask, 	XK_l,      	move,  {.com=(char*[]){"resize", "right"}, .i=20}},

    {MOD,           	XK_Left,   	move,  {.com=(char*[]){"move", "left"}, .i=20}},
    {MOD,           	XK_Down,   	move,  {.com=(char*[]){"move", "down"}, .i=20}},
    {MOD,           	XK_Up,     	move,  {.com=(char*[]){"move", "up"}, .i=20}},
    {MOD,           	XK_Right,  	move,  {.com=(char*[]){"move", "right"}, .i=20}},
    {MOD|ShiftMask, 	XK_Left,   	move,  {.com=(char*[]){"resize", "left"}, .i=20}},
    {MOD|ShiftMask, 	XK_Down,   	move,  {.com=(char*[]){"resize", "down"}, .i=20}},
